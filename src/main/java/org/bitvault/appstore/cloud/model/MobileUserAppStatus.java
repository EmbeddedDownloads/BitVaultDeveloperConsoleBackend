...
import com.fasterxml.jackson.annotation.JsonManagedReference;
	 ...
	 */
	@Entity
	@Table(name = "mobile_user_app_status")
	@EntityListeners(AuditingEntityListener.class)
	public class MobileUserAppStatus implements Serializable {
		private static final long serialVersionUID = 1L;

		@Id
		@GeneratedValue(strategy = GenerationType.IDENTITY)
		@Column(name = "mobile_user_app_status_id", unique = true, nullable = false)
		...
		public MobileUserAppStatusDto populateMobileUserAppDto(MobileUserAppStatus mobileUserApp) {
			MobileUserAppStatusDto mobileUserAppDto = new MobileUserAppStatusDto();
			try {
